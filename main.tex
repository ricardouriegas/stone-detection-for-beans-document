...
\section{Resultados}
    ...
    \begin{figure}[H]
        ...
        \caption{Secciones de la Interfaz Marcadas con Números para cada Sección}
        \label{fig:secciones}
    \end{figure}
    ...
    \begin{enumerate}
        ...
        \item "Reserved": Botón reservado para futuras implementaciones.
        \item "Guardar": Botón para guardar la imagen procesada.
        \item Sección izquierda: Contiene la imagen original.
